...
// import './trainers.json'
  ...
  function App() {
    ...
    const professorOakPokemon = async() => {
      ...
      const pokeImg = await(myPokemon);
      
      return pokeImg.sprites.other.showdown.front_default
    }
    ...
    const story = async() => {
      ...
      }else if(pageOfStory == 3 ){
        textBoxText.innerHTML = "I'm name is Professor Oak.."

      }else if(pageOfStory == 4 ){
